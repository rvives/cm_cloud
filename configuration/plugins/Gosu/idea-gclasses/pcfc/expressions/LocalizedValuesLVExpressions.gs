...
class LocalizedValuesLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends LocalizedValuesLVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=column0_Cell) at LocalizedValuesLV.pcf: line 43, column 41
    function defaultSetter_15 (__VALUE_TO_SET :  java.lang.Object) : void {
      entity[fieldNames[0] + "_" + language.Code] = __VALUE_TO_SET
    }
    
    // 'value' attribute on TextCell (id=column1_Cell) at LocalizedValuesLV.pcf: line 51, column 46
    function defaultSetter_22 (__VALUE_TO_SET :  java.lang.Object) : void {
      entity[fieldNames[1] + "_" + language.Code] = __VALUE_TO_SET
    }
    
    // 'value' attribute on TextCell (id=column2_Cell) at LocalizedValuesLV.pcf: line 59, column 46
    ...
    // 'label' attribute on TextCell (id=column0_Cell) at LocalizedValuesLV.pcf: line 43, column 41
    function label_13 () : java.lang.Object {
      return columnNames[0]
    }
    
    // 'label' attribute on TextCell (id=column1_Cell) at LocalizedValuesLV.pcf: line 51, column 46
    function label_20 () : java.lang.Object {
      return columnNames[1]
    }
    
    // 'label' attribute on TextCell (id=column2_Cell) at LocalizedValuesLV.pcf: line 59, column 46
    function label_28 () : java.lang.Object {
      return columnNames[2]
    }
    
    // 'validationExpression' attribute on TextCell (id=column0_Cell) at LocalizedValuesLV.pcf: line 43, column 41
    function validationExpression_12 () : java.lang.Object {
      return copyValueIfNotSet(language, 0)
    }
    
    // 'validationExpression' attribute on TextCell (id=column1_Cell) at LocalizedValuesLV.pcf: line 51, column 46
    function validationExpression_19 () : java.lang.Object {
      return copyValueIfNotSet(language, 1)
    }
    
    // 'validationExpression' attribute on TextCell (id=column2_Cell) at LocalizedValuesLV.pcf: line 59, column 46
    function validationExpression_27 () : java.lang.Object {
      return copyValueIfNotSet(language, 2)
    }
    
    // 'value' attribute on TextCell (id=Language_Cell) at LocalizedValuesLV.pcf: line 36, column 154
    ...
    // 'value' attribute on TextCell (id=column2_Cell) at LocalizedValuesLV.pcf: line 59, column 46
    function value_29 () : java.lang.Object {
      return entity[fieldNames[2] + "_" + language.Code]
    }
    
    // 'visible' attribute on TextCell (id=column1_Cell) at LocalizedValuesLV.pcf: line 51, column 46
    function visible_24 () : java.lang.Boolean {
      return fieldNames.Count > 1
    }
    
    // 'visible' attribute on TextCell (id=column2_Cell) at LocalizedValuesLV.pcf: line 59, column 46
  ...
  public static class LocalizedValuesLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=column1_Cell) at LocalizedValuesLV.pcf: line 51, column 46
    function sortValue_5 (language :  typekey.LanguageType) : java.lang.Object {
      return entity[fieldNames[1] + "_" + language.Code]
    }
    
    // 'value' attribute on TextCell (id=column2_Cell) at LocalizedValuesLV.pcf: line 59, column 46
    function sortValue_8 (language :  typekey.LanguageType) : java.lang.Object {
      return entity[fieldNames[2] + "_" + language.Code]
    }
