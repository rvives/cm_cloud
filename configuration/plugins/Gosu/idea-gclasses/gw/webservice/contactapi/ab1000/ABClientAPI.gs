...
interface ABClientAPI {
   ...
   */
  function pendingUpdateRejected(context: gw.webservice.contactapi.ab1000.ABClientAPIPendingChangeContext)
   ...
   * @param context the context information for the change
   */
  function pendingCreateRejected(context: gw.webservice.contactapi.ab1000.ABClientAPIPendingChangeContext)
   ...
   * @param context the context information for the change
   */
  function pendingCreateApproved(context: gw.webservice.contactapi.ab1000.ABClientAPIPendingChangeContext)
   ...
   */
  function pendingUpdateApproved(context: gw.webservice.contactapi.ab1000.ABClientAPIPendingChangeContext, abuidContainer: ABClientAPIAddressBookUIDContainer)
