...
final class ABClientAPIAddressBookUIDContainer implements IABClientAPIAddressBookUIDContainer {
   ...
   */
  public var AddressBookUIDTuples : gw.webservice.contactapi.ab1000.ABClientAPIAddressBookUIDTuple[]

  construct() {}

  override function updateAddressBookUIDTuples(value: List<AddressBookUIDTuple>) {
    AddressBookUIDTuples = value.toArray(new gw.webservice.contactapi.ab1000.ABClientAPIAddressBookUIDTuple[value.size()])
  }
}
