...
uses gw.webservice.ab.ab5040.abcontactapi.ABContactAPIDocumentSearchCriteria
uses gw.webservice.ab.ab5040.abcontactapi.ABContactAPIDocumentSearchResultContainer
uses gw.webservice.ab.ab5040.abcontactapi.ABContactAPIDocumentSearchSpec
uses gw.webservice.ab.ab5040.abcontactapi.ABContactAPIFindDuplicatesResultContainer
uses gw.webservice.ab.ab5040.abcontactapi.ABContactAPIPendingContactChange
uses gw.webservice.ab.ab5040.abcontactapi.ABContactAPISearchCriteria
uses gw.webservice.ab.ab5040.abcontactapi.ABContactAPISearchResultContainer
uses gw.webservice.ab.ab5040.abcontactapi.ABContactAPISearchSpec
uses gw.webservice.ab.ab5040.abcontactapi.ABContactAPISpecialistService
uses gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil
uses gw.webservice.ab.ab5040.abcontactapi.ABContactAPIValidateCreateContactResult
uses gw.webservice.ab.ab5040.abcontactapi.AddressBookUIDContainer
uses gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler
uses gw.webservice.ab.ab5040.abcontactapi.RelatedContactInfoContainer
...
@WsiWebService( "http://guidewire.com/ab/ws/gw/webservice/ab/ab5040/abcontactapi/ABContactAPI" )
...
@WsiExposeEnumAsString(typekey.OfficialIDType)
@WsiExposeEnumAsString(typekey.Jurisdiction)
...
class ABContactAPI {
  ...
  function updateContact(abContactXML : XmlBackedInstance) : gw.webservice.ab.ab5040.abcontactapi.AddressBookUIDContainer {
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(abContactXML, "abContactXML")
    return gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions<gw.webservice.ab.ab5040.abcontactapi.AddressBookUIDContainer>(\-> {
      return gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.updateContact(abContactXML)
    })
  }
  ...
  @Throws(SOAPSenderException, "Thrown in the event of a general SOAP sender error")
  @WsiCheckDuplicateExternalTransaction
  function createContact(abContactXML : XmlBackedInstance) : gw.webservice.ab.ab5040.abcontactapi.AddressBookUIDContainer {
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(abContactXML, "abContactXML")
    return gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions<gw.webservice.ab.ab5040.abcontactapi.AddressBookUIDContainer>(\-> {
      return gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.createContact(abContactXML)
    })
  }
  ...
  @Throws(SOAPSenderException, "Thrown in the event of a general SOAP sender error")
  @Throws(PermissionException, "If the user the remote application is calling ABContactAPI as doesn't have the neccessary permissions for this operation.")
  function validateCreateContact(abContactXML : XmlBackedInstance) : gw.webservice.ab.ab5040.abcontactapi.ABContactAPIValidateCreateContactResult {
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(abContactXML, "abContactXML")
    return gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions<ABContactAPIValidateCreateContactResult>(\-> {
      return gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.validateCreateContact(abContactXML)
    })
  }
  ...
  function updateContactPendingApproval(
    ...
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(abContactXML, "abContactXML")
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(updateContext, "updateContext")

    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions(\-> {
      gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.updateContactPendingApproval(abContactXML, updateContext)
      return null
    })
  }
  ...
  function createContactPendingApproval(abContactXML : XmlBackedInstance,
                                        updateContext : ABContactAPIPendingContactChange) : gw.webservice.ab.ab5040.abcontactapi.AddressBookUIDContainer {
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(abContactXML, "abContactXML")
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(updateContext, "updateContext")
    return gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions<AddressBookUIDContainer>(\-> {
      return gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.createContactPendingApproval(abContactXML, updateContext)
    })
  }
  ...
  function removeContact(abContactXML : XmlBackedInstance) : boolean {
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(abContactXML, "abContactXML")
    return gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions<Boolean>(\-> {
      return gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.removeContact(abContactXML)
    })
  }
  ...
  function searchContact(abContactAPISearchCriteria : ABContactAPISearchCriteria,
                         abContactAPISearchSpec : gw.webservice.ab.ab5040.abcontactapi.ABContactAPISearchSpec)
  : ABContactAPISearchResultContainer {
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(abContactAPISearchCriteria, "abContactSearchCriteriaInfo")
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(abContactAPISearchSpec, "abContactAPISearchSpec")
    return gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions<ABContactAPISearchResultContainer>(\-> {
      return gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.searchContact(abContactAPISearchCriteria, abContactAPISearchSpec) as ABContactAPISearchResultContainer
    })
  }
  ...
  : ABContactAPIFindDuplicatesResultContainer {
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(abContactXML, "abContactXML")
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(abContactAPISearchSpec, "abContactAPISearchSpec")
    return gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions<ABContactAPIFindDuplicatesResultContainer>(\-> {
      return (gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.findDuplicates(abContactXML, abContactAPISearchSpec)) as ABContactAPIFindDuplicatesResultContainer
    })
  }
  ...
  function retrieveContact(linkID : String) : XmlBackedInstance {
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(linkID, "linkID")
    return gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions<XmlBackedInstance>(\-> {
      return gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.retrieveContact(linkID)
    })
  }
  ...
  function retrieveRelatedContacts(linkID : String, relationshipTypes : ContactBidiRel[]) : RelatedContactInfoContainer {
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(linkID, "linkID")
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(relationshipTypes, "relationshipTypes")
    return gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions<RelatedContactInfoContainer>(\-> {
      return (gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.retrieveRelatedContacts(linkID, relationshipTypes)) as RelatedContactInfoContainer
    })
  }
  ...
  function getReplacementAddress(addressLinkID : String) : String {
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(addressLinkID, "addressLinkID")
    return gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions<String>(\-> {
      return gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.getReplacementAddress(addressLinkID)
    })
  }
  ...
  function getReplacementContact(contactLinkID : String) : String {
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(contactLinkID, "contactLinkID")
    return gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions<String>(\-> {
      return gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.getReplacementContact(contactLinkID)
    })
  }
  ...
  function getSpecialistServices(contactLinkID : String) : ABContactAPISpecialistService[] {
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(contactLinkID, "contactLinkID")
    return gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.handleExceptions<ABContactAPISpecialistService[]>(\-> {
      var result = gw.webservice.ab.ab5040.abcontactapi.ABContactAPIUtil.getSpecialistServices(contactLinkID)
  ...
  function retrieveDocumentsForContact(contactLinkID : String, abContactAPIDocumentSearchCriteria : ABContactAPIDocumentSearchCriteria,
    ...
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(contactLinkID, "contactLinkID")
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(abContactAPIDocumentSearchCriteria, "abContactAPIDocumentSearchCriteria")
    gw.webservice.ab.ab5040.abcontactapi.ExceptionHandler.require(abContactAPIDocumentSearchSpec, "abContactAPIDocumentSearchSpec")
