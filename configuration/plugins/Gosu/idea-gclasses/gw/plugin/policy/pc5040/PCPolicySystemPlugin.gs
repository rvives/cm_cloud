package gw.plugin.policy.pc5040
...
uses wsi.remote.gw.webservice.pc.pc5040.beanmodel.XmlBackedInstance
uses wsi.remote.gw.webservice.pc.pc5040.contactapi.ContactAPI
uses wsi.remote.gw.webservice.pc.pc5040.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples
uses wsi.remote.gw.webservice.pc.pc5040.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples_Entry
uses wsi.remote.gw.webservice.pc.pc5040.contactapi.faults.BadIdentifierException
uses wsi.remote.gw.webservice.pc.pc5040.contactapi.faults.IllegalArgumentException
uses wsi.remote.gw.webservice.pc.pc5040.contactapi.faults.RequiredFieldException
uses wsi.remote.gw.webservice.pc.pc5040.contactapi.faults.SOAPException
uses wsi.remote.gw.webservice.pc.pc5040.contactapi.types.complex.ABClientAPIAddressBookUIDContainer
uses wsi.remote.gw.webservice.pc.pc5040.contactapi.types.complex.ABClientAPIPendingChangeContext
uses entity.ABContact


@Export
class PCPolicySystemPlugin extends ClientSystemPlugin5040 {
  ...
  protected function createRemoteABClientAPIPendingChangeContext(contextXml : String) : ABClientAPIPendingChangeContext {
    ...
    var clientContext = new ABClientAPIPendingChangeContext() {
      ...
      :Resolution = wsi.remote.gw.webservice.pc.pc5040.contactapi.enums.ContactChangeResolution.forGosuValue(context.Resolution.Code),
