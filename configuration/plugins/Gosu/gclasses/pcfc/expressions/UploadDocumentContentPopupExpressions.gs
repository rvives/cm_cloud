...
@javax.annotation.processing.Generated("config/web/pcf/contacts/UploadDocumentContentPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class UploadDocumentContentPopupExpressions {
  ...
  public static class UploadDocumentContentPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function beforeCommit_8 (pickedValue :  java.lang.Object) : void {
      document.isCompatibleMimeType(documentFile); document.uploadContent(documentFile)
    }
    ...
    function label_1 () : java.lang.String {
      return DisplayKey.get("Web.ContactDetail.Documents.UpdateDocument.UpdateContent", document.getMimeTypeLabel(document.MimeType), document.Name)
    }
