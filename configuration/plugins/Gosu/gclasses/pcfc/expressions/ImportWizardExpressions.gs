...
@javax.annotation.processing.Generated("config/web/pcf/admin/importexport/ImportWizard.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ImportWizardExpressions {
  ...
  public static class ImportWizardExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function allowFinish_1 () : java.lang.Boolean {
      return ImportDataInfo.Successful and ((ImportDataInfo.File != null and ImportDataInfo.NumConflicts == 0) or ImportDataInfo.ResolutionStrategy != MANUAL)
    }
    
    // 'allowNext' attribute on WizardStep (id=Upload) at ImportWizard.pcf: line 24, column 78
    function allowNext_2 () : java.lang.Boolean {
      return ImportDataInfo.Successful and (ImportDataInfo.File != null and ImportDataInfo.NumConflicts > 0 and ImportDataInfo.ResolutionStrategy == MANUAL)
    }
