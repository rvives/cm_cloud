...
class Plugin extends BaseCommand {
  ...
  private static final var _pc5000Plugin = new PluginDefMock("PolicySystemPlugin", ClientSystemPlugin, new gw.plugin.policy.pc5000.PCPolicySystemPlugin())
  private static final var _pc5040Plugin = new PluginDefMock("PolicySystemPlugin", ClientSystemPlugin, new gw.plugin.policy.pc5040.PCPolicySystemPlugin())
  ...
  protected static final var _pc5000 : String = "pc5000"
  protected static final var _pc5040 : String = "pc5040"
  ...
  private static final var _pcPluginMap : Map<String, PluginDefMock> = {
      _live -> _pc900Plugin,
      _pc5000 -> _pc5000Plugin,
      _pc5040 -> _pc5040Plugin,
  ...
  @Argument("impl", {Plugin._live, Plugin._standalone,Plugin._pc5040, Plugin._pc5000, Plugin._pc1000, Plugin._pc900, Plugin._reset})
