package gw.webservice.ab.ab5000
 ...
 */
@WsiWebService("http://guidewire.com/ab/ws/gw/webservice/ab/ab5000/MessagingToolsAPI")
...
class MessagingToolsAPI {
   ...
   * @throws gw.api.webservice.exception.SOAPException If the ack could not be committed to the database
