...
uses gw.webservice.ab.ab5040.abcontactapi.AddressInfo
...
@Export
@gw.xml.ws.annotation.WsiExportable( "http://guidewire.com/ab/ws/gw/webservice/ab/ab5040/abcontactapi/ABContactAPISearchResult" )
final class ABContactAPISearchResult implements IABContactAPISearchResult {
  ...
  public var OfficialID : ABContactAPIABOfficialIDParameters[]
  ...
  construct(contact : ABContact) {
    ...
    this.OfficialID = getContactOfficialIDs(contact.ABOfficialIDs)
  }

  private function getContactOfficialIDs(contactOfficialID : entity.ABOfficialID[]) : ABContactAPIABOfficialIDParameters[] {
    var ABOfficialIDParameters = new ArrayList<ABContactAPIABOfficialIDParameters>()
    for (officialID in contactOfficialID) {
      var ABOfficialIDParameter = new ABContactAPIABOfficialIDParameters()
      ABOfficialIDParameter.OfficialIDType = officialID.OfficialIDType
      ABOfficialIDParameter.OfficialIDValue = officialID.OfficialIDValue
      ABOfficialIDParameter.State = officialID.State
      ABOfficialIDParameters.add(ABOfficialIDParameter)
    }
    return ABOfficialIDParameters.toTypedArray()
  }
}
