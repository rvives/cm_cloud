package gw.plugin.claim.cc5040
...
uses wsi.remote.gw.webservice.cc.cc5040.beanmodel.XmlBackedInstance
uses wsi.remote.gw.webservice.cc.cc5040.contactapi.ContactAPI
uses wsi.remote.gw.webservice.cc.cc5040.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples
uses wsi.remote.gw.webservice.cc.cc5040.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples_Entry
uses wsi.remote.gw.webservice.cc.cc5040.contactapi.types.complex.ABClientAPIAddressBookUIDContainer
uses wsi.remote.gw.webservice.cc.cc5040.contactapi.types.complex.ABClientAPIPendingChangeContext


@Export
class CCClaimSystemPlugin extends ClientSystemPlugin5040 {
  ...
  override protected function isNonRetryableSOAPException(e : Exception) : boolean {
    return  e typeis wsi.remote.gw.webservice.cc.cc5040.contactapi.faults.BadIdentifierException or
            e typeis wsi.remote.gw.webservice.cc.cc5040.contactapi.faults.RequiredFieldException or
            e typeis wsi.remote.gw.webservice.cc.cc5040.contactapi.faults.SOAPSenderException
  }
  ...
  protected function createRemoteABClientAPIPendingChangeContext(contextXml : String) : ABClientAPIPendingChangeContext {
    ...
    var clientContext = new ABClientAPIPendingChangeContext() {
      ...
      :Resolution = wsi.remote.gw.webservice.cc.cc5040.contactapi.enums.ContactChangeResolution.forGosuValue(context.Resolution.Code),
