package gw.plugin.policy.pc5000

uses gw.api.contact.IAddressBookUIDContainer
uses gw.plugin.integration.ClientSystemPlugin5000
uses gw.webservice.ab.ab5000.abclientapi.ABClientAPIAddressBookUIDContainerUtil
uses gw.xml.XmlElement
uses gw.xml.ws.WsdlConfig
uses gw.xml.ws.WsiExportableUtil
uses wsi.remote.gw.webservice.pc.pc5000.beanmodel.XmlBackedInstance
uses wsi.remote.gw.webservice.pc.pc5000.contactapi.ContactAPI
uses wsi.remote.gw.webservice.pc.pc5000.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples
uses wsi.remote.gw.webservice.pc.pc5000.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples_Entry
uses wsi.remote.gw.webservice.pc.pc5000.contactapi.faults.BadIdentifierException
uses wsi.remote.gw.webservice.pc.pc5000.contactapi.faults.IllegalArgumentException
uses wsi.remote.gw.webservice.pc.pc5000.contactapi.faults.RequiredFieldException
uses wsi.remote.gw.webservice.pc.pc5000.contactapi.faults.SOAPException
uses wsi.remote.gw.webservice.pc.pc5000.contactapi.types.complex.ABClientAPIAddressBookUIDContainer
uses wsi.remote.gw.webservice.pc.pc5000.contactapi.types.complex.ABClientAPIPendingChangeContext
uses entity.ABContact


@Export
class PCPolicySystemPlugin extends ClientSystemPlugin5000 {
  ...
  protected function createRemoteABClientAPIPendingChangeContext(contextXml : String) : ABClientAPIPendingChangeContext {
    ...
    var clientContext = new ABClientAPIPendingChangeContext() {
      ...
      :Resolution = wsi.remote.gw.webservice.pc.pc5000.contactapi.enums.ContactChangeResolution.forGosuValue(context.Resolution.Code),
