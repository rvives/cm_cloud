package gw.plugin.billing.bc5040

uses gw.api.contact.IAddressBookUIDContainer
uses gw.plugin.integration.ClientSystemPlugin5040
uses gw.webservice.ab.ab5040.abclientapi.ABClientAPIAddressBookUIDContainerUtil
uses gw.xml.XmlElement
uses gw.xml.ws.WsdlConfig
uses gw.xml.ws.WsiExportableUtil
uses wsi.remote.gw.webservice.bc.bc5040.beanmodel.XmlBackedInstance
uses wsi.remote.gw.webservice.bc.bc5040.contactapi.ContactAPI
uses wsi.remote.gw.webservice.bc.bc5040.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples
uses wsi.remote.gw.webservice.bc.bc5040.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples_Entry
uses wsi.remote.gw.webservice.bc.bc5040.contactapi.faults.BadIdentifierException
uses wsi.remote.gw.webservice.bc.bc5040.contactapi.faults.IllegalArgumentException
uses wsi.remote.gw.webservice.bc.bc5040.contactapi.faults.IllegalStateException
uses wsi.remote.gw.webservice.bc.bc5040.contactapi.faults.RequiredFieldException
uses wsi.remote.gw.webservice.bc.bc5040.contactapi.types.complex.ABClientAPIAddressBookUIDContainer
uses wsi.remote.gw.webservice.bc.bc5040.contactapi.types.complex.ABClientAPIPendingChangeContext
uses entity.ABContact

@Export
class BCBillingSystemPlugin extends ClientSystemPlugin5040 {
  ...
  protected function createRemoteABClientAPIPendingChangeContext(contextXml : String) : ABClientAPIPendingChangeContext {
    ...
    var clientContext = new ABClientAPIPendingChangeContext() {
      ...
      :Resolution = wsi.remote.gw.webservice.bc.bc5040.contactapi.enums.ContactChangeResolution.forGosuValue(context.Resolution.Code),
  ...
  protected function createRemoteABClientAddressBookUIDContainer(abuidContainerXml : String) : ABClientAPIAddressBookUIDContainer {
    ...
    clientContainer.AddressBookUIDTuples.Entry = new ArrayList<ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples_Entry>()
