...
class ABExtensionInterfacesMapper implements ExtensionInterfacesMapper {
  ...
  override function bindImplementations(config: ExtensionInterfacesConfig) {
    ...
    config.setImplementation<gw.contactmapper.ab5000.IContactIntegrationMapperFactoryExtensions>(\ -> gw.contactmapper.ab5000.ContactIntegrationMapperFactory.get())
    config.setImplementation<gw.webservice.ab.ab5000.abcontactapi.IRelatedContactInfoContainerFactory>(\ -> new gw.webservice.ab.ab5000.abcontactapi.RelatedContactInfoContainer())
    config.setImplementation<gw.webservice.ab.ab5000.abcontactapi.IABContactAPIRelatedContactFactory>(\ -> new gw.webservice.ab.ab5000.abcontactapi.ABContactAPIRelatedContact())
    config.setImplementation<gw.webservice.ab.ab5000.abcontactapi.IABContactAPISearchResultContainerFactory>(\ -> new gw.webservice.ab.ab5000.abcontactapi.ABContactAPISearchResultContainer())
    config.setImplementation<gw.webservice.ab.ab5000.abcontactapi.IABContactAPISearchResultFactory>(\ contact -> new gw.webservice.ab.ab5000.abcontactapi.ABContactAPISearchResult(contact))
    config.setImplementation<gw.webservice.ab.ab5000.abcontactapi.IABContactAPIFindDuplicatesResultContainerFactory>(\ -> new gw.webservice.ab.ab5000.abcontactapi.ABContactAPIFindDuplicatesResultContainer())
    config.setImplementation<gw.webservice.ab.ab5000.abcontactapi.IABContactAPIFindDuplicatesResultFactory>(\ contact, exactMatch -> new gw.webservice.ab.ab5000.abcontactapi.ABContactAPIFindDuplicatesResult(contact, exactMatch))
    config.setImplementation<gw.webservice.ab.ab5000.abcontactapi.IABContactAPISpecialistServiceFactory>(\ service -> new gw.webservice.ab.ab5000.abcontactapi.ABContactAPISpecialistService(service))
    config.setImplementation<gw.contactmapper.ab5040.IContactIntegrationMapperFactoryExtensions>(\ -> gw.contactmapper.ab5040.ContactIntegrationMapperFactory.get())
    config.setImplementation<gw.webservice.ab.ab5040.abcontactapi.IRelatedContactInfoContainerFactory>(\ -> new gw.webservice.ab.ab5040.abcontactapi.RelatedContactInfoContainer())
    config.setImplementation<gw.webservice.ab.ab5040.abcontactapi.IABContactAPIRelatedContactFactory>(\ -> new gw.webservice.ab.ab5040.abcontactapi.ABContactAPIRelatedContact())
    config.setImplementation<gw.webservice.ab.ab5040.abcontactapi.IABContactAPISearchResultContainerFactory>(\ -> new gw.webservice.ab.ab5040.abcontactapi.ABContactAPISearchResultContainer())
    config.setImplementation<gw.webservice.ab.ab5040.abcontactapi.IABContactAPISearchResultFactory>(\ contact -> new gw.webservice.ab.ab5040.abcontactapi.ABContactAPISearchResult(contact))
    config.setImplementation<gw.webservice.ab.ab5040.abcontactapi.IABContactAPIFindDuplicatesResultContainerFactory>(\ -> new gw.webservice.ab.ab5040.abcontactapi.ABContactAPIFindDuplicatesResultContainer())
    config.setImplementation<gw.webservice.ab.ab5040.abcontactapi.IABContactAPIFindDuplicatesResultFactory>(\ contact, exactMatch -> new gw.webservice.ab.ab5040.abcontactapi.ABContactAPIFindDuplicatesResult(contact, exactMatch))
    config.setImplementation<gw.webservice.ab.ab5040.abcontactapi.IABContactAPISpecialistServiceFactory>(\ service -> new gw.webservice.ab.ab5040.abcontactapi.ABContactAPISpecialistService(service))
    ...
    config.setImplementation<AddressBookUIDTupleFactory>(\ -> new gw.webservice.contactapi.ab5040.ABClientAPIAddressBookUIDTuple())
    ...
    config.setImplementation<gw.webservice.contactapi.ab5000.IABClientAPIAddressBookUIDContainerFactory>(\ -> new gw.webservice.contactapi.ab5000.ABClientAPIAddressBookUIDContainer())
    config.setImplementation<gw.webservice.contactapi.ab5040.IABClientAPIAddressBookUIDContainerFactory>(\ -> new gw.webservice.contactapi.ab5040.ABClientAPIAddressBookUIDContainer())
    ...
    config.setImplementation<gw.webservice.ab.ab5000.abcontactapi.IABContactAPIDocumentInfoFactory>(\ document -> new gw.webservice.ab.ab5000.abcontactapi.ABContactAPIDocumentInfo(document))
    config.setImplementation<gw.webservice.ab.ab5000.abcontactapi.IABContactAPIDocumentSearchResultContainerFactory>(\ -> new gw.webservice.ab.ab5000.abcontactapi.ABContactAPIDocumentSearchResultContainer())
    config.setImplementation<gw.webservice.ab.ab5040.abcontactapi.IABContactAPIDocumentInfoFactory>(\ document -> new gw.webservice.ab.ab5040.abcontactapi.ABContactAPIDocumentInfo(document))
    config.setImplementation<gw.webservice.ab.ab5040.abcontactapi.IABContactAPIDocumentSearchResultContainerFactory>(\ -> new gw.webservice.ab.ab5040.abcontactapi.ABContactAPIDocumentSearchResultContainer())
