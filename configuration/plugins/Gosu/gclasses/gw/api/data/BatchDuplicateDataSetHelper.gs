...
class BatchDuplicateDataSetHelper extends DataSetsHelperBase {
  ...
  private function generateExistingContacts () {
    ...
    new ABPolicyCompanyBuilder().withName("Hayward Municipal Airport").withTaxID("84-2582519").withWorkPhone("510-542-1854").withNotes("C").create()
  ...
  private function generateBatchContacts () {    // These are the contacts that should be found by the Duplicate Batch process
    ...
    var primaryContact1 = new ABPersonBuilder().withFirstName("Primary").withLastName("Contact").withAddress(abAddress111).withWorkPhone("650-611-5489").createAndCommit()
    var employee1 = new ABPersonBuilder().withFirstName("Employee").withLastName("Contact").withAddress(abAddress112).withWorkPhone("650-611-5489").createAndCommit()
