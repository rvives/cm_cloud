...
class AddressHistoryFieldUtil {
  ...
  public static function getAddressFieldsToTrack(address : entity.Address) : Map<String,String> {
    ...
    var fieldsToTrack = new HashMap<String, String>() {
        ...
        "City"         -> address.Country == Country.TC_US ? "Web.AddressBook.AddressInputSet.City" : addressCountrySettings.CityLabel,
        "County"       -> "Web.AddressBook.AddressInputSet.County",
        "State"        -> address.Country == Country.TC_US ? "Web.AddressBook.AddressInputSet.State" : addressCountrySettings.StateLabel,
        "PostalCode"   -> address.Country == Country.TC_US ? "Web.AddressBook.AddressInputSet.ZIP" : addressCountrySettings.PostalCodeLabel,
