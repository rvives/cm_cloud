...
uses gw.commons.metadata.i18n.config.IGWLocale
...
class NameLocaleSettings {
  ...
  static property get Locale() : IGWLocale {
    var locale = LocaleUtil.getCurrentLocale()
    init(locale)
    return locale
  }

  static private function init(_locale : IGWLocale) {
