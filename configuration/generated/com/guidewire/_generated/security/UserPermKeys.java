...
public class UserPermKeys {
  ...
  public static final StaticPermissionKey CLIENTAPP = new StaticPermissionKey("clientapp", entity.User.class.getSimpleName(), com.guidewire.pl.system.security.PermissionHandlerConfig.builder().withPermissions("clientapp").withDescription("Permission to access from an external application").build());
