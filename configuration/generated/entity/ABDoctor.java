...
@gw.entity.EntityName(value = "ABDoctor")
public class ABDoctor extends entity.ABPersonVendor {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABDoctor> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABDoctor>("entity.ABDoctor");
   ...
   */
  public ABDoctor(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABDoctor(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABDoctorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABDoctorInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABDoctorInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABDoctorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABDoctor.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABDoctor.class, config);
    com.guidewire._generated.entity.ABDoctorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABDoctor, com.guidewire._generated.entity.ABDoctorInternal>() {
      public java.lang.Object getImplementation(entity.ABDoctor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABDoctorInternal getInternalInterface(entity.ABDoctor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABDoctor newEmptyInstance() {
        return new entity.ABDoctor((java.lang.Void)null);
      }
