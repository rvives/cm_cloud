 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PendingContactChangeView.eti;PendingContactChangeView.eix;PendingContactChangeView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PendingContactChangeView")
public class PendingContactChangeView extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PendingContactChangeView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PendingContactChangeView>("entity.PendingContactChangeView");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ABCONTACT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ABContact");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ABCONTACTNAME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ABContactName");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REQUESTINGUSER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RequestingUser");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> SUBTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Subtype");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.PendingContactChangeViewInternal _internal;
   ...
   */
  public PendingContactChangeView()  {
   ...
   */
  public PendingContactChangeView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PendingContactChangeView(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PendingContactChangeViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PendingContactChangeViewInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.PendingContactChangeView value) {
    __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PendingContactChangeViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PendingContactChangeView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PendingContactChangeView.class, config);
    com.guidewire._generated.entity.PendingContactChangeViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PendingContactChangeView, com.guidewire._generated.entity.PendingContactChangeViewInternal>() {
      public java.lang.Object getImplementation(entity.PendingContactChangeView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PendingContactChangeViewInternal getInternalInterface(entity.PendingContactChangeView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PendingContactChangeView newEmptyInstance() {
        return new entity.PendingContactChangeView((java.lang.Void)null);
      }
