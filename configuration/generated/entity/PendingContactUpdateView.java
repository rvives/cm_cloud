...
@gw.entity.EntityName(value = "PendingContactUpdateView")
public class PendingContactUpdateView extends entity.PendingContactChangeView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PendingContactUpdateView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PendingContactUpdateView>("entity.PendingContactUpdateView");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PENDINGCONTACTUPDATE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PendingContactUpdate");
   ...
   */
  public PendingContactUpdateView()  {
   ...
   */
  public PendingContactUpdateView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PendingContactUpdateView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PendingContactUpdateViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PendingContactUpdateViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PendingContactUpdateViewInternal)super.__getInternalInterface();
  }
  ...
  public entity.PendingContactUpdate getPendingContactUpdate() {
    return (entity.PendingContactUpdate)__getInternalInterface().getFieldValue(PENDINGCONTACTUPDATE_PROP.get());
  }
  ...
  public void setPendingContactUpdate(entity.PendingContactUpdate value) {
    __getInternalInterface().setFieldValue(PENDINGCONTACTUPDATE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PendingContactUpdateViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PendingContactUpdateView.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getPendingContactUpdateID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PENDINGCONTACTUPDATE_PROP.get());
    }
    ...
    public void setPendingContactUpdateID(gw.pl.persistence.core.Key value) {
      setFieldValue(PENDINGCONTACTUPDATE_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PendingContactUpdateView.class, config);
    com.guidewire._generated.entity.PendingContactUpdateViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PendingContactUpdateView, com.guidewire._generated.entity.PendingContactUpdateViewInternal>() {
      public java.lang.Object getImplementation(entity.PendingContactUpdateView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PendingContactUpdateViewInternal getInternalInterface(entity.PendingContactUpdateView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PendingContactUpdateView newEmptyInstance() {
        return new entity.PendingContactUpdateView((java.lang.Void)null);
      }
