 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABContactSearchCriteriaSpecialistService.eti;ABContactSearchCriteriaSpecialistService.eix;ABContactSearchCriteriaSpecialistService.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABContactSearchCriteriaSpecialistService")
public class ABContactSearchCriteriaSpecialistService extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABContactSearchCriteriaSpecialistService> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABContactSearchCriteriaSpecialistService>("entity.ABContactSearchCriteriaSpecialistService");
  ...
  private com.guidewire._generated.entity.ABContactSearchCriteriaSpecialistServiceInternal _internal;
   ...
   */
  public ABContactSearchCriteriaSpecialistService()  {
   ...
   */
  public ABContactSearchCriteriaSpecialistService(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABContactSearchCriteriaSpecialistService(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ABContactSearchCriteriaSpecialistServiceInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABContactSearchCriteriaSpecialistServiceInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABContactSearchCriteriaSpecialistServiceInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABContactSearchCriteriaSpecialistService.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.ab.addressbook.entity.ABContactSearchCriteriaSpecialistService", "com.guidewire.ab.domain.addressbook.impl.ABContactSearchCriteriaSpecialistServiceImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABContactSearchCriteriaSpecialistService.class, config);
    com.guidewire._generated.entity.ABContactSearchCriteriaSpecialistServiceInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABContactSearchCriteriaSpecialistService, com.guidewire._generated.entity.ABContactSearchCriteriaSpecialistServiceInternal>() {
      public java.lang.Object getImplementation(entity.ABContactSearchCriteriaSpecialistService bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABContactSearchCriteriaSpecialistServiceInternal getInternalInterface(entity.ABContactSearchCriteriaSpecialistService bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABContactSearchCriteriaSpecialistService newEmptyInstance() {
        return new entity.ABContactSearchCriteriaSpecialistService((java.lang.Void)null);
      }
