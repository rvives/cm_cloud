 ...
 * Generic person.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABPerson.eti;ABPerson.eix;ABPerson.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABPerson")
public class ABPerson extends entity.ABContact implements entity.GlobalPersonName {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABPerson> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABPerson>("entity.ABPerson");
   ...
   */
  public ABPerson(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABPerson(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABPersonInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABPersonInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABPersonInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABPersonInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABPerson.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABPerson.class, config);
    com.guidewire._generated.entity.ABPersonInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABPerson, com.guidewire._generated.entity.ABPersonInternal>() {
      public java.lang.Object getImplementation(entity.ABPerson bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABPersonInternal getInternalInterface(entity.ABPerson bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABPerson newEmptyInstance() {
        return new entity.ABPerson((java.lang.Void)null);
      }
