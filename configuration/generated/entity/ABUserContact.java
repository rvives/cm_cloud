 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABUserContact.eti;ABUserContact.eix;ABUserContact.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABUserContact")
public class ABUserContact extends entity.ABPerson {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABUserContact> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABUserContact>("entity.ABUserContact");
   ...
   */
  public ABUserContact(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABUserContact(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABUserContactInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABUserContactInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABUserContactInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABUserContactInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABUserContact.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABUserContact.class, config);
    com.guidewire._generated.entity.ABUserContactInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABUserContact, com.guidewire._generated.entity.ABUserContactInternal>() {
      public java.lang.Object getImplementation(entity.ABUserContact bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABUserContactInternal getInternalInterface(entity.ABUserContact bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABUserContact newEmptyInstance() {
        return new entity.ABUserContact((java.lang.Void)null);
      }
