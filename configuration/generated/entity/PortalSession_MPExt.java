 ...
 *   
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PortalSession_MPExt.eti;PortalSession_MPExt.eix;PortalSession_MPExt.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PortalSession_MPExt")
public class PortalSession_MPExt extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PortalSession_MPExt> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PortalSession_MPExt>("entity.PortalSession_MPExt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PUBLICID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PublicID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FOREIGNID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "foreignId");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SESSIONTYPE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "sessionType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SESSIONUUID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "sessionUUID");
  ...
  private com.guidewire._generated.entity.PortalSession_MPExtInternal _internal;
   ...
   */
  public PortalSession_MPExt(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PortalSession_MPExt(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PortalSession_MPExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PortalSession_MPExtInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getforeignId() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(FOREIGNID_PROP.get());
  }
  ...
  public java.lang.String getsessionType() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(SESSIONTYPE_PROP.get());
  }
  ...
  public java.lang.String getsessionUUID() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(SESSIONUUID_PROP.get());
  }
  ...
  public void setforeignId(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(FOREIGNID_PROP.get(), value);
  }
  ...
  public void setsessionType(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(SESSIONTYPE_PROP.get(), value);
  }
  ...
  public void setsessionUUID(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(SESSIONUUID_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PortalSession_MPExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PortalSession_MPExt.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PortalSession_MPExt.class, config);
    com.guidewire._generated.entity.PortalSession_MPExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PortalSession_MPExt, com.guidewire._generated.entity.PortalSession_MPExtInternal>() {
      public java.lang.Object getImplementation(entity.PortalSession_MPExt bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PortalSession_MPExtInternal getInternalInterface(entity.PortalSession_MPExt bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PortalSession_MPExt newEmptyInstance() {
        return new entity.PortalSession_MPExt((java.lang.Void)null);
      }
