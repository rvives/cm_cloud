 ...
 * ABAutoRepairShop
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABAutoRepairShop.eti;ABAutoRepairShop.eix;ABAutoRepairShop.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABAutoRepairShop")
public class ABAutoRepairShop extends entity.ABCompanyVendor {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABAutoRepairShop> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABAutoRepairShop>("entity.ABAutoRepairShop");
   ...
   */
  public ABAutoRepairShop(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABAutoRepairShop(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABAutoRepairShopInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABAutoRepairShopInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABAutoRepairShopInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABAutoRepairShopInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABAutoRepairShop.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABAutoRepairShop.class, config);
    com.guidewire._generated.entity.ABAutoRepairShopInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABAutoRepairShop, com.guidewire._generated.entity.ABAutoRepairShopInternal>() {
      public java.lang.Object getImplementation(entity.ABAutoRepairShop bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABAutoRepairShopInternal getInternalInterface(entity.ABAutoRepairShop bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABAutoRepairShop newEmptyInstance() {
        return new entity.ABAutoRepairShop((java.lang.Void)null);
      }
