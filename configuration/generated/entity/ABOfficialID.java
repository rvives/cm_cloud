...
@gw.entity.EntityName(value = "ABOfficialID")
public class ABOfficialID extends com.guidewire.pl.persistence.code.BeanBase implements entity.Obfuscatable, entity.Extractable, entity.ABLinkable, entity.Retireable, com.guidewire.pl.domain.contact.OfficialIDBase, gw.api.obfuscation.Obfuscator {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABOfficialID> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABOfficialID>("entity.ABOfficialID");
  ...
  private com.guidewire._generated.entity.ABOfficialIDInternal _internal;
   ...
   */
  public ABOfficialID(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABOfficialID(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ABOfficialIDInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABOfficialIDInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.ABOfficialID getSubtype() {
    return (typekey.ABOfficialID)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
   ...
   */
  private void setSubtype(typekey.ABOfficialID value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABOfficialIDInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABOfficialID.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.contact.OfficialIDBase", "com.guidewire.ab.domain.addressbook.impl.ABOfficialIDImpl");
    config.put("com.guidewire.pl.domain.contact.OfficialIDPublicMethods", "com.guidewire.ab.domain.addressbook.impl.ABOfficialIDImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABOfficialID.class, config);
    com.guidewire._generated.entity.ABOfficialIDInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABOfficialID, com.guidewire._generated.entity.ABOfficialIDInternal>() {
      public java.lang.Object getImplementation(entity.ABOfficialID bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABOfficialIDInternal getInternalInterface(entity.ABOfficialID bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABOfficialID newEmptyInstance() {
        return new entity.ABOfficialID((java.lang.Void)null);
      }
