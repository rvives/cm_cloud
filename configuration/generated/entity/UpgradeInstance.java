...
public class UpgradeInstance extends com.guidewire.pl.persistence.code.BeanBase implements entity.TimedUpgraderObject, entity.KeyableBean, com.guidewire.commons.profiler.ProfilerDataSourceInternal, com.guidewire.pl.system.database.upgrade.info.IStartAndEndTimeProvider, com.guidewire.pl.system.database.upgrade.info.IUpgradeInstanceInfo {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BLUEGREENOPTION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BlueGreenOption");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FORCED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Forced");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PROPOSEDUPGRADESCHEMAREPORT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ProposedUpgradeSchemaReport");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SCHEMAREPORTENDTIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "SchemaReportEndTime");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SCHEMAREPORTSTARTTIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "SchemaReportStartTime");
  ...
  /**
   * Gets the value of the BlueGreenOption field.
   * Whether this is a blue/green upgrade and how far it should progress
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Integer getBlueGreenOption() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(BLUEGREENOPTION_PROP.get());
  }
  
  /**
   * 
   * @return Type of blue/green upgrade or null if not a blue/green upgrade
   */
  @javax.annotation.Nullable
  public gw.upgrade.BlueGreenOption getBlueGreenType() {
    return ((com.guidewire.pl.domain.upgrader.UpgradeInstancePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.upgrader.UpgradeInstancePublicMethods")).getBlueGreenType();
  }
  ...
  public java.lang.String getFormattedSchemaReportDuration() {
    return ((com.guidewire.pl.domain.upgrader.UpgradeInstancePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.upgrader.UpgradeInstancePublicMethods")).getFormattedSchemaReportDuration();
  }
  ...
  /**
   * Gets the value of the ProposedUpgradeSchemaReport field.
   * Upgrade DDL that will be executed if associated blue/green upgrade is performed
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public gw.lang.Blob getProposedUpgradeSchemaReport() {
    return (gw.lang.Blob)__getInternalInterface().getFieldValue(PROPOSEDUPGRADESCHEMAREPORT_PROP.get());
  }
  ...
  /**
   * Gets the value of the SchemaReportEndTime field.
   * Timestamp when the generate upgrade schema report portion of the upgrade ended
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.util.Date getSchemaReportEndTime() {
    return (java.util.Date)__getInternalInterface().getFieldValue(SCHEMAREPORTENDTIME_PROP.get());
  }
  
  /**
   * Gets the value of the SchemaReportStartTime field.
   * Timestamp when the generate upgrade schema report portion of the upgrade started
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.util.Date getSchemaReportStartTime() {
    return (java.util.Date)__getInternalInterface().getFieldValue(SCHEMAREPORTSTARTTIME_PROP.get());
  }
  ...
  /**
   * 
   * @return true if a blue/green upgrade is enabled
   */
  public boolean isBlueGreen() {
    return ((com.guidewire.pl.domain.upgrader.UpgradeInstancePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.upgrader.UpgradeInstancePublicMethods")).isBlueGreen();
  }
   ...
   * Only applicable for a reverse migration. True if this reverse migration was forced
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Boolean isForced() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(FORCED_PROP.get());
  }
  ...
  /**
   * Sets the value of the BlueGreenOption field.
   */
  public void setBlueGreenOption(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(BLUEGREENOPTION_PROP.get(), value);
  }
  ...
  public void setForced(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(FORCED_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the ProposedUpgradeSchemaReport field.
   */
  public void setProposedUpgradeSchemaReport(gw.lang.Blob value) {
    __getInternalInterface().setFieldValue(PROPOSEDUPGRADESCHEMAREPORT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the SchemaReportEndTime field.
   */
  public void setSchemaReportEndTime(java.util.Date value) {
    __getInternalInterface().setFieldValue(SCHEMAREPORTENDTIME_PROP.get(), value);
  }
  
  /**
   * Sets the value of the SchemaReportStartTime field.
   */
  public void setSchemaReportStartTime(java.util.Date value) {
    __getInternalInterface().setFieldValue(SCHEMAREPORTSTARTTIME_PROP.get(), value);
  }
