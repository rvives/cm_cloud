 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "InsuranceCompany.eti;InsuranceCompany.eix;InsuranceCompany.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "InsuranceCompany")
public class InsuranceCompany extends entity.Company {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.InsuranceCompany> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.InsuranceCompany>("entity.InsuranceCompany");
   ...
   */
  public InsuranceCompany(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected InsuranceCompany(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.InsuranceCompanyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.InsuranceCompanyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.InsuranceCompanyInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.InsuranceCompanyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.InsuranceCompany.this.__getDelegateManager();
    }
    ...
    public gw.api.domain.PropertyMatchHandlerMap getPropertyMatchHandlerMap() {
  ...
  static {
    ...
    config.put("com.guidewire.ab.domain.personaldata.purge.DestructionRootPinnablePublicMethods", "com.guidewire.ab.domain.contact.ContactImpl");
    ...
    config.put("gw.api.contact.ContactLifecycle", "gw.api.contact.ContactLifecycleImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.InsuranceCompany.class, config);
    com.guidewire._generated.entity.InsuranceCompanyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.InsuranceCompany, com.guidewire._generated.entity.InsuranceCompanyInternal>() {
      public java.lang.Object getImplementation(entity.InsuranceCompany bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.InsuranceCompanyInternal getInternalInterface(entity.InsuranceCompany bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.InsuranceCompany newEmptyInstance() {
        return new entity.InsuranceCompany((java.lang.Void)null);
      }
