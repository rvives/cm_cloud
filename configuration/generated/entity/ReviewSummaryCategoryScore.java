 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ReviewSummaryCategoryScore.eti;ReviewSummaryCategoryScore.eix;ReviewSummaryCategoryScore.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ReviewSummaryCategoryScore")
public class ReviewSummaryCategoryScore extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Versionable, com.guidewire.pl.domain.contact.CommonCategoryScore {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ReviewSummaryCategoryScore> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ReviewSummaryCategoryScore>("entity.ReviewSummaryCategoryScore");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> REVIEWSUMMARY_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ReviewSummary");
  ...
  private com.guidewire._generated.entity.ReviewSummaryCategoryScoreInternal _internal;
   ...
   */
  public ReviewSummaryCategoryScore(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ReviewSummaryCategoryScore(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ReviewSummaryCategoryScoreInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ReviewSummaryCategoryScoreInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.ReviewSummary getReviewSummary() {
    return (entity.ReviewSummary)__getInternalInterface().getFieldValue(REVIEWSUMMARY_PROP.get());
  }
  ...
  public void setReviewSummary(entity.ReviewSummary value) {
    __getInternalInterface().setFieldValue(REVIEWSUMMARY_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ReviewSummaryCategoryScoreInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ReviewSummaryCategoryScore.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getReviewSummaryID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(REVIEWSUMMARY_PROP.get());
    }
    ...
    public void setReviewSummaryID(gw.pl.persistence.core.Key value) {
      setFieldValue(REVIEWSUMMARY_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.contact.CommonCategoryScore", "com.guidewire.ab.domain.addressbook.impl.ReviewSummaryCategoryScoreImpl");
    ...
    config.put("gw.ab.addressbook.entity.ReviewSummaryCategoryScore", "com.guidewire.ab.domain.addressbook.impl.ReviewSummaryCategoryScoreImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ReviewSummaryCategoryScore.class, config);
    com.guidewire._generated.entity.ReviewSummaryCategoryScoreInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ReviewSummaryCategoryScore, com.guidewire._generated.entity.ReviewSummaryCategoryScoreInternal>() {
      public java.lang.Object getImplementation(entity.ReviewSummaryCategoryScore bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ReviewSummaryCategoryScoreInternal getInternalInterface(entity.ReviewSummaryCategoryScore bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ReviewSummaryCategoryScore newEmptyInstance() {
        return new entity.ReviewSummaryCategoryScore((java.lang.Void)null);
      }
