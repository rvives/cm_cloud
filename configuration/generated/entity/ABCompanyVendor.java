 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABCompanyVendor.eti;ABCompanyVendor.eix;ABCompanyVendor.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABCompanyVendor")
public class ABCompanyVendor extends entity.ABCompany {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABCompanyVendor> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABCompanyVendor>("entity.ABCompanyVendor");
   ...
   */
  public ABCompanyVendor(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABCompanyVendor(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABCompanyVendorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABCompanyVendorInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABCompanyVendorInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABCompanyVendorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABCompanyVendor.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABCompanyVendor.class, config);
    com.guidewire._generated.entity.ABCompanyVendorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABCompanyVendor, com.guidewire._generated.entity.ABCompanyVendorInternal>() {
      public java.lang.Object getImplementation(entity.ABCompanyVendor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABCompanyVendorInternal getInternalInterface(entity.ABCompanyVendor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABCompanyVendor newEmptyInstance() {
        return new entity.ABCompanyVendor((java.lang.Void)null);
      }
