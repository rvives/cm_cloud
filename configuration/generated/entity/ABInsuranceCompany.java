...
/**
 * ABInsuranceCompany
 * Contact type representing insurance companies.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABInsuranceCompany.eti;ABInsuranceCompany.eix;ABInsuranceCompany.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABInsuranceCompany")
public class ABInsuranceCompany extends entity.ABCompany {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABInsuranceCompany> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABInsuranceCompany>("entity.ABInsuranceCompany");
   ...
   */
  public ABInsuranceCompany(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABInsuranceCompany(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABInsuranceCompanyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABInsuranceCompanyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABInsuranceCompanyInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABInsuranceCompanyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABInsuranceCompany.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABInsuranceCompany.class, config);
    com.guidewire._generated.entity.ABInsuranceCompanyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABInsuranceCompany, com.guidewire._generated.entity.ABInsuranceCompanyInternal>() {
      public java.lang.Object getImplementation(entity.ABInsuranceCompany bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABInsuranceCompanyInternal getInternalInterface(entity.ABInsuranceCompany bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABInsuranceCompany newEmptyInstance() {
        return new entity.ABInsuranceCompany((java.lang.Void)null);
      }
