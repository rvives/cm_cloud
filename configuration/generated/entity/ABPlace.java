 ...
 * Generic place.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABPlace.eti;ABPlace.eix;ABPlace.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABPlace")
public class ABPlace extends entity.ABContact {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABPlace> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABPlace>("entity.ABPlace");
   ...
   */
  public ABPlace(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABPlace(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABPlaceInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABPlaceInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABPlaceInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABPlaceInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABPlace.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.ab.addressbook.entity.ABContact", "com.guidewire.ab.domain.addressbook.impl.ABPlaceImpl");
    config.put("gw.ab.addressbook.entity.ABLinkable", "com.guidewire.ab.domain.addressbook.impl.ABContactImpl");
    config.put("gw.ab.addressbook.entity.ABPlace", "com.guidewire.ab.domain.addressbook.impl.ABPlaceImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABPlace.class, config);
    com.guidewire._generated.entity.ABPlaceInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABPlace, com.guidewire._generated.entity.ABPlaceInternal>() {
      public java.lang.Object getImplementation(entity.ABPlace bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABPlaceInternal getInternalInterface(entity.ABPlace bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABPlace newEmptyInstance() {
        return new entity.ABPlace((java.lang.Void)null);
      }
