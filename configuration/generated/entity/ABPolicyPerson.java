 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABPolicyPerson.eti;ABPolicyPerson.eix;ABPolicyPerson.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABPolicyPerson")
public class ABPolicyPerson extends entity.ABPerson {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABPolicyPerson> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABPolicyPerson>("entity.ABPolicyPerson");
   ...
   */
  public ABPolicyPerson(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABPolicyPerson(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABPolicyPersonInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABPolicyPersonInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABPolicyPersonInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABPolicyPersonInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABPolicyPerson.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.ab.addressbook.entity.ABContact", "com.guidewire.ab.domain.addressbook.impl.ABPersonImpl");
    config.put("gw.ab.addressbook.entity.ABLinkable", "com.guidewire.ab.domain.addressbook.impl.ABContactImpl");
    config.put("gw.ab.addressbook.entity.ABPerson", "com.guidewire.ab.domain.addressbook.impl.ABPersonImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABPolicyPerson.class, config);
    com.guidewire._generated.entity.ABPolicyPersonInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABPolicyPerson, com.guidewire._generated.entity.ABPolicyPersonInternal>() {
      public java.lang.Object getImplementation(entity.ABPolicyPerson bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABPolicyPersonInternal getInternalInterface(entity.ABPolicyPerson bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABPolicyPerson newEmptyInstance() {
        return new entity.ABPolicyPerson((java.lang.Void)null);
      }
