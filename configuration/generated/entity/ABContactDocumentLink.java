 ...
 * Associates ABContacts with Documents. It supports many contacts associated to the same document and viceversa.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABContactDocumentLink.eti;ABContactDocumentLink.eix;ABContactDocumentLink.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABContactDocumentLink")
public class ABContactDocumentLink extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABContactDocumentLink> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABContactDocumentLink>("entity.ABContactDocumentLink");
  ...
  private com.guidewire._generated.entity.ABContactDocumentLinkInternal _internal;
   ...
   */
  protected ABContactDocumentLink()  {
   ...
   */
  protected ABContactDocumentLink(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABContactDocumentLink(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ABContactDocumentLinkInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABContactDocumentLinkInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABContactDocumentLinkInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABContactDocumentLink.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.document.DocumentJoiningBean", "com.guidewire.ab.domain.contact.impl.ABContactDocumentLinkImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.CommitCallback", "com.guidewire.ab.domain.contact.impl.ABContactDocumentLinkImpl");
    config.put("gw.ab.contact.entity.ABContactDocumentLink", "com.guidewire.ab.domain.contact.impl.ABContactDocumentLinkImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABContactDocumentLink.class, config);
    com.guidewire._generated.entity.ABContactDocumentLinkInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABContactDocumentLink, com.guidewire._generated.entity.ABContactDocumentLinkInternal>() {
      public java.lang.Object getImplementation(entity.ABContactDocumentLink bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABContactDocumentLinkInternal getInternalInterface(entity.ABContactDocumentLink bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABContactDocumentLink newEmptyInstance() {
        return new entity.ABContactDocumentLink((java.lang.Void)null);
      }
