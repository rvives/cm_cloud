 ...
 * ABAutoTowingAgcy
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABAutoTowingAgcy.eti;ABAutoTowingAgcy.eix;ABAutoTowingAgcy.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABAutoTowingAgcy")
public class ABAutoTowingAgcy extends entity.ABCompanyVendor {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABAutoTowingAgcy> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABAutoTowingAgcy>("entity.ABAutoTowingAgcy");
   ...
   */
  public ABAutoTowingAgcy(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABAutoTowingAgcy(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABAutoTowingAgcyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABAutoTowingAgcyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABAutoTowingAgcyInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABAutoTowingAgcyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABAutoTowingAgcy.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABAutoTowingAgcy.class, config);
    com.guidewire._generated.entity.ABAutoTowingAgcyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABAutoTowingAgcy, com.guidewire._generated.entity.ABAutoTowingAgcyInternal>() {
      public java.lang.Object getImplementation(entity.ABAutoTowingAgcy bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABAutoTowingAgcyInternal getInternalInterface(entity.ABAutoTowingAgcy bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABAutoTowingAgcy newEmptyInstance() {
        return new entity.ABAutoTowingAgcy((java.lang.Void)null);
      }
