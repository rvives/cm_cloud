 ...
 * ABContactSpecialistService
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABContactSpecialistService.eti;ABContactSpecialistService.eix;ABContactSpecialistService.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABContactSpecialistService")
public class ABContactSpecialistService extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABContactSpecialistService> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABContactSpecialistService>("entity.ABContactSpecialistService");
  ...
  private com.guidewire._generated.entity.ABContactSpecialistServiceInternal _internal;
   ...
   */
  public ABContactSpecialistService(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABContactSpecialistService(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ABContactSpecialistServiceInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABContactSpecialistServiceInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSpecialistService(entity.SpecialistService value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABContactSpecialistServiceInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABContactSpecialistService.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.ab.domain.addressbook.impl.ABContactSpecialistServiceImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.ab.domain.addressbook.impl.ABContactSpecialistServiceImpl");
    config.put("gw.ab.addressbook.entity.ABContactSpecialistService", "com.guidewire.ab.domain.addressbook.impl.ABContactSpecialistServiceImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABContactSpecialistService.class, config);
    com.guidewire._generated.entity.ABContactSpecialistServiceInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABContactSpecialistService, com.guidewire._generated.entity.ABContactSpecialistServiceInternal>() {
      public java.lang.Object getImplementation(entity.ABContactSpecialistService bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABContactSpecialistServiceInternal getInternalInterface(entity.ABContactSpecialistService bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABContactSpecialistService newEmptyInstance() {
        return new entity.ABContactSpecialistService((java.lang.Void)null);
      }
