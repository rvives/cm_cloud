 ...
 * Attorney
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABAttorney.eti;ABAttorney.eix;ABAttorney.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABAttorney")
public class ABAttorney extends entity.ABPersonVendor {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABAttorney> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABAttorney>("entity.ABAttorney");
   ...
   */
  public ABAttorney(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABAttorney(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABAttorneyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABAttorneyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABAttorneyInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABAttorneyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABAttorney.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABAttorney.class, config);
    com.guidewire._generated.entity.ABAttorneyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABAttorney, com.guidewire._generated.entity.ABAttorneyInternal>() {
      public java.lang.Object getImplementation(entity.ABAttorney bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABAttorneyInternal getInternalInterface(entity.ABAttorney bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABAttorney newEmptyInstance() {
        return new entity.ABAttorney((java.lang.Void)null);
      }
