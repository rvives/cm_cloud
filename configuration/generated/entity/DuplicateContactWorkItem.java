 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "DuplicateContactWorkItem.eti;DuplicateContactWorkItem.eix;DuplicateContactWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "DuplicateContactWorkItem")
public class DuplicateContactWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DuplicateContactWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DuplicateContactWorkItem>("entity.DuplicateContactWorkItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NUMBEROFRESULTS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NumberOfResults");
  ...
  private com.guidewire._generated.entity.DuplicateContactWorkItemInternal _internal;
   ...
   */
  public DuplicateContactWorkItem()  {
   ...
   */
  public DuplicateContactWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DuplicateContactWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.DuplicateContactWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DuplicateContactWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.Integer getNumberOfResults() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(NUMBEROFRESULTS_PROP.get());
  }
  ...
  public void setNumberOfResults(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(NUMBEROFRESULTS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DuplicateContactWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DuplicateContactWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DuplicateContactWorkItem.class, config);
    com.guidewire._generated.entity.DuplicateContactWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DuplicateContactWorkItem, com.guidewire._generated.entity.DuplicateContactWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.DuplicateContactWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DuplicateContactWorkItemInternal getInternalInterface(entity.DuplicateContactWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DuplicateContactWorkItem newEmptyInstance() {
        return new entity.DuplicateContactWorkItem((java.lang.Void)null);
      }
