 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PendingContactCreate.eti;PendingContactCreate.eix;PendingContactCreate.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PendingContactCreate")
public class PendingContactCreate extends entity.PendingContactChange {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PendingContactCreate> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PendingContactCreate>("entity.PendingContactCreate");
   ...
   */
  public PendingContactCreate(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PendingContactCreate(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PendingContactCreateInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PendingContactCreateInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PendingContactCreateInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PendingContactCreateInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PendingContactCreate.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PendingContactCreate.class, config);
    com.guidewire._generated.entity.PendingContactCreateInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PendingContactCreate, com.guidewire._generated.entity.PendingContactCreateInternal>() {
      public java.lang.Object getImplementation(entity.PendingContactCreate bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PendingContactCreateInternal getInternalInterface(entity.PendingContactCreate bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PendingContactCreate newEmptyInstance() {
        return new entity.PendingContactCreate((java.lang.Void)null);
      }
