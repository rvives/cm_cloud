 ...
 * Queue of ABContacts to be scored for Service Provider Management. Work items are recorded as the ID value of ABContact entities. This is a system-internal entity.
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABContactScoringWorkItem.eti;ABContactScoringWorkItem.eix;ABContactScoringWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABContactScoringWorkItem")
public class ABContactScoringWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABContactScoringWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABContactScoringWorkItem>("entity.ABContactScoringWorkItem");
  ...
  private com.guidewire._generated.entity.ABContactScoringWorkItemInternal _internal;
   ...
   */
  public ABContactScoringWorkItem()  {
   ...
   */
  public ABContactScoringWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABContactScoringWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ABContactScoringWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABContactScoringWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABContactScoringWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABContactScoringWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.ab.addressbook.entity.ABContactScoringWorkItem", "com.guidewire.ab.domain.addressbook.impl.ABContactScoringWorkItemImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABContactScoringWorkItem.class, config);
    com.guidewire._generated.entity.ABContactScoringWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABContactScoringWorkItem, com.guidewire._generated.entity.ABContactScoringWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.ABContactScoringWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABContactScoringWorkItemInternal getInternalInterface(entity.ABContactScoringWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABContactScoringWorkItem newEmptyInstance() {
        return new entity.ABContactScoringWorkItem((java.lang.Void)null);
      }
