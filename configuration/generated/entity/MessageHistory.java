...
public class MessageHistory extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PRIMARYOBJECTID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PrimaryObjectId");
  ...
  public java.lang.Long getPrimaryObjectId() {
    return (java.lang.Long)__getInternalInterface().getFieldValue(PRIMARYOBJECTID_PROP.get());
  }
   ...
   */
  private void setPrimaryObjectId(java.lang.Long value) {
    __getInternalInterface().setFieldValue(PRIMARYOBJECTID_PROP.get(), value);
  }
