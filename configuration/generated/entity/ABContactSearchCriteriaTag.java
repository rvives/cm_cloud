 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABContactSearchCriteriaTag.eti;ABContactSearchCriteriaTag.eix;ABContactSearchCriteriaTag.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABContactSearchCriteriaTag")
public class ABContactSearchCriteriaTag extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABContactSearchCriteriaTag> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABContactSearchCriteriaTag>("entity.ABContactSearchCriteriaTag");
  ...
  private com.guidewire._generated.entity.ABContactSearchCriteriaTagInternal _internal;
   ...
   */
  public ABContactSearchCriteriaTag()  {
   ...
   */
  public ABContactSearchCriteriaTag(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABContactSearchCriteriaTag(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ABContactSearchCriteriaTagInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABContactSearchCriteriaTagInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABContactSearchCriteriaTagInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABContactSearchCriteriaTag.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.ab.addressbook.entity.ABContactSearchCriteriaTag", "com.guidewire.ab.domain.addressbook.impl.ABContactSearchCriteriaTagImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABContactSearchCriteriaTag.class, config);
    com.guidewire._generated.entity.ABContactSearchCriteriaTagInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABContactSearchCriteriaTag, com.guidewire._generated.entity.ABContactSearchCriteriaTagInternal>() {
      public java.lang.Object getImplementation(entity.ABContactSearchCriteriaTag bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABContactSearchCriteriaTagInternal getInternalInterface(entity.ABContactSearchCriteriaTag bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABContactSearchCriteriaTag newEmptyInstance() {
        return new entity.ABContactSearchCriteriaTag((java.lang.Void)null);
      }
