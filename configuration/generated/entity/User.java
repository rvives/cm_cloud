...
public class User extends com.guidewire.pl.persistence.code.BeanBase implements entity.Validatable, entity.Retireable, entity.Obfuscatable, entity.EventAware, gw.api.obfuscation.Obfuscator {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INTEGEREXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IntegerExt");
  ...
  public static final gw.api.admin.PublicUserFinder publicFinder = com.guidewire.pl.domain.community.UserPublicMethods.publicFinder;
   ...
   * @deprecated Use ({@link User#getGroupUsers()} instead).
   */
  ...
  public entity.GroupUser[] getAllGroupUsersAsArray() {
    return ((com.guidewire.ab.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.ab.domain.community.impl.UserCoreExtMethods")).getAllGroupUsersAsArray();
  }
  ...
  public java.lang.Integer getIntegerExt() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(INTEGEREXT_PROP.get());
  }
  ...
  public void setIntegerExt(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(INTEGEREXT_PROP.get(), value);
  }
  ...
  static {
    ...
    config.put("com.guidewire.ab.domain.community.impl.UserCoreExtMethods", "com.guidewire.ab.domain.community.impl.UserCoreExtMethodsImpl");
