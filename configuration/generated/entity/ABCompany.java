 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABCompany.eti;ABCompany.eix;ABCompany.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABCompany")
public class ABCompany extends entity.ABContact {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABCompany> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABCompany>("entity.ABCompany");
   ...
   */
  public ABCompany(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABCompany(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABCompanyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABCompanyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABCompanyInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABCompanyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABCompany.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABCompany.class, config);
    com.guidewire._generated.entity.ABCompanyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABCompany, com.guidewire._generated.entity.ABCompanyInternal>() {
      public java.lang.Object getImplementation(entity.ABCompany bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABCompanyInternal getInternalInterface(entity.ABCompany bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABCompany newEmptyInstance() {
        return new entity.ABCompany((java.lang.Void)null);
      }
