...
@gw.entity.EntityName(value = "ABContactAddress")
public class ABContactAddress extends com.guidewire.pl.persistence.code.BeanBase implements entity.CommonContactAddress, entity.ABLinkable, entity.Extractable, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABContactAddress> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABContactAddress>("entity.ABContactAddress");
  ...
  private com.guidewire._generated.entity.ABContactAddressInternal _internal;
   ...
   */
  public ABContactAddress(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABContactAddress(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ABContactAddressInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABContactAddressInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABContactAddressInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABContactAddress.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.contact.impl.CommonContactAddressImplCallback", "com.guidewire.ab.domain.addressbook.impl.ABContactAddressImpl");
    ...
    config.put("gw.ab.addressbook.entity.ABContactAddress", "com.guidewire.ab.domain.addressbook.impl.ABContactAddressImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABContactAddress.class, config);
    com.guidewire._generated.entity.ABContactAddressInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABContactAddress, com.guidewire._generated.entity.ABContactAddressInternal>() {
      public java.lang.Object getImplementation(entity.ABContactAddress bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABContactAddressInternal getInternalInterface(entity.ABContactAddress bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABContactAddress newEmptyInstance() {
        return new entity.ABContactAddress((java.lang.Void)null);
      }
