 ...
 * Judge or arbitrator.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABAdjudicator.eti;ABAdjudicator.eix;ABAdjudicator.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABAdjudicator")
public class ABAdjudicator extends entity.ABPerson {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABAdjudicator> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABAdjudicator>("entity.ABAdjudicator");
   ...
   */
  public ABAdjudicator(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABAdjudicator(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABAdjudicatorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABAdjudicatorInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABAdjudicatorInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABAdjudicatorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABAdjudicator.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABAdjudicator.class, config);
    com.guidewire._generated.entity.ABAdjudicatorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABAdjudicator, com.guidewire._generated.entity.ABAdjudicatorInternal>() {
      public java.lang.Object getImplementation(entity.ABAdjudicator bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABAdjudicatorInternal getInternalInterface(entity.ABAdjudicator bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABAdjudicator newEmptyInstance() {
        return new entity.ABAdjudicator((java.lang.Void)null);
      }
