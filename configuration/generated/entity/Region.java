...
public class Region extends com.guidewire.pl.persistence.code.BeanBase implements entity.Validatable, entity.DecentralizedEntity, entity.Retireable, gw.api.zones.ZoneContainer {
  ...
  /**
   * Create a new zone based on the zone type and the country
   * @param zoneType the zone type
   * @param country the country
   * @return a created zone
   */
  public entity.ZoneDelegate createZone(typekey.ZoneType zoneType, typekey.Country country) {
    return ((gw.api.zones.ZoneContainer)__getDelegateManager().getImplementation("gw.api.zones.ZoneContainer")).createZone(zoneType, country);
  }
  ...
  /**
   * The zone types based on the configuration of the country
   * @param country the country
   * @return an array of zone types based on the country
   */
  public typekey.ZoneType[] getDefaultZoneTypes(typekey.Country country) {
    return ((gw.api.zones.ZoneContainer)__getDelegateManager().getImplementation("gw.api.zones.ZoneContainer")).getDefaultZoneTypes(country);
  }
  ...
  public gw.api.admin.ZoneSearchCriteria getFilterCriteria() {
    return ((gw.api.zones.ZoneContainer)__getDelegateManager().getImplementation("gw.api.zones.ZoneContainer")).getFilterCriteria();
  }
  ...
  /**
   * Array association accessor for key en_US_EDG on array Name_L10N_ARRAY
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getName_en_US_EDG() {
    return (java.lang.String)__getInternalInterface().getLocalizedFieldValueForCodeGen((com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo)TYPE.get().getTypeInfo().getProperty("Name_en_US_EDG"));
  }
  
  /**
   * Array association accessor for key en_US_EDG_PH on array Name_L10N_ARRAY
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getName_en_US_EDG_PH() {
    return (java.lang.String)__getInternalInterface().getLocalizedFieldValueForCodeGen((com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo)TYPE.get().getTypeInfo().getProperty("Name_en_US_EDG_PH"));
  }
  ...
  public java.lang.String[] getZoneCodes() {
    return ((gw.api.zones.ZoneContainer)__getDelegateManager().getImplementation("gw.api.zones.ZoneContainer")).getZoneCodes();
  }
  ...
  /**
   * An array of zone types
   * @param zoneType the zone type
   * @return an array of zone types based on the zone tyupe
   */
  public entity.ZoneDelegate[] getZonesByZoneType(typekey.ZoneType zoneType) {
    return ((gw.api.zones.ZoneContainer)__getDelegateManager().getImplementation("gw.api.zones.ZoneContainer")).getZonesByZoneType(zoneType);
  }
  ...
  /**
   * Remove the zone from the stored zones
   * @param zone the zone
   */
  public void removeFromZones(entity.ZoneDelegate zone) {
    ((gw.api.zones.ZoneContainer)__getDelegateManager().getImplementation("gw.api.zones.ZoneContainer")).removeFromZones(zone);
  }
  ...
  public void setFilterCriteria(gw.api.admin.ZoneSearchCriteria filterCriteria) {
    ((gw.api.zones.ZoneContainer)__getDelegateManager().getImplementation("gw.api.zones.ZoneContainer")).setFilterCriteria(filterCriteria);
  }
   ...
   * Array association mutator for key Name_ on array Name_L10N_ARRAY
   */
  public void setName_en_US_EDG(java.lang.String value) {
    __getInternalInterface().setLocalizedFieldValueForCodeGen((com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo)TYPE.get().getTypeInfo().getProperty("Name_en_US_EDG"), value);
  }
  
  /**
   * Array association mutator for key Name_ on array Name_L10N_ARRAY
   */
  public void setName_en_US_EDG_PH(java.lang.String value) {
    __getInternalInterface().setLocalizedFieldValueForCodeGen((com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo)TYPE.get().getTypeInfo().getProperty("Name_en_US_EDG_PH"), value);
  }
  ...
  public void setZoneCodes(java.lang.String[] zones) {
    ((gw.api.zones.ZoneContainer)__getDelegateManager().getImplementation("gw.api.zones.ZoneContainer")).setZoneCodes(zones);
  }
  ...
  static {
    ...
    config.put("gw.api.zones.ZoneContainer", "com.guidewire.pl.domain.assignment.impl.RegionImpl");
