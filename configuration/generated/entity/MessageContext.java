...
public class MessageContext extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
   ...
   * Note that this is for delayed {@link Message#getPayload() payload} specification; it
   * should be set before this message is sent.
   */
  public entity.Message createMessage() {
    return ((com.guidewire.pl.domain.messaging.MessageContextPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.messaging.MessageContextPublicMethods")).createMessage();
  }
  ...
  public entity.Message createPersonalDataPurgeMessage(java.lang.String payload) {
    return ((com.guidewire.ab.domain.messaging.impl.MessageContextCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.ab.domain.messaging.impl.MessageContextCoreExtMethods")).createPersonalDataPurgeMessage(payload);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.MessageContextInternal {
    ...
    public boolean isLastEventForDestination() {
      return ((com.guidewire.pl.domain.messaging.impl.MessageContextInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.messaging.impl.MessageContextInternalMethods")).isLastEventForDestination();
    }
    ...
    public void setLastEventForDestination(boolean value) {
      ((com.guidewire.pl.domain.messaging.impl.MessageContextInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.messaging.impl.MessageContextInternalMethods")).setLastEventForDestination(value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.ab.domain.messaging.impl.MessageContextCoreExtMethods", "com.guidewire.ab.domain.messaging.impl.MessageContextCoreExtMethodsImpl");
