 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PendingContactUpdate.eti;PendingContactUpdate.eix;PendingContactUpdate.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PendingContactUpdate")
public class PendingContactUpdate extends entity.PendingContactChange {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CHANGEXML_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ChangeXML");
  ...
  protected com.guidewire._generated.entity.PendingContactUpdateInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PendingContactUpdateInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the ChangeXML field.
   * XML representation of the contact change.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getChangeXML() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CHANGEXML_PROP.get());
  }
  
  /**
   * Sets the value of the ChangeXML field.
   */
  public void setChangeXML(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CHANGEXML_PROP.get(), value);
  }
