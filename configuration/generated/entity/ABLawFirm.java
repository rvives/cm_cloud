 ...
 * ABLawFirm
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABLawFirm.eti;ABLawFirm.eix;ABLawFirm.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABLawFirm")
public class ABLawFirm extends entity.ABCompanyVendor {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABLawFirm> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABLawFirm>("entity.ABLawFirm");
   ...
   */
  public ABLawFirm(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABLawFirm(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ABLawFirmInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABLawFirmInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ABLawFirmInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABLawFirmInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABLawFirm.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABLawFirm.class, config);
    com.guidewire._generated.entity.ABLawFirmInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABLawFirm, com.guidewire._generated.entity.ABLawFirmInternal>() {
      public java.lang.Object getImplementation(entity.ABLawFirm bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABLawFirmInternal getInternalInterface(entity.ABLawFirm bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABLawFirm newEmptyInstance() {
        return new entity.ABLawFirm((java.lang.Void)null);
      }
