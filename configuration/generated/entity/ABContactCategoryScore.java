 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ABContactCategoryScore.eti;ABContactCategoryScore.eix;ABContactCategoryScore.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ABContactCategoryScore")
public class ABContactCategoryScore extends com.guidewire.pl.persistence.code.BeanBase implements entity.ABLinkable, entity.Extractable, entity.Versionable, com.guidewire.pl.domain.contact.CommonCategoryScore {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ABContactCategoryScore> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ABContactCategoryScore>("entity.ABContactCategoryScore");
  ...
  private com.guidewire._generated.entity.ABContactCategoryScoreInternal _internal;
   ...
   */
  public ABContactCategoryScore(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ABContactCategoryScore(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ABContactCategoryScoreInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ABContactCategoryScoreInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ABContactCategoryScoreInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ABContactCategoryScore.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.contact.CommonCategoryScore", "com.guidewire.ab.domain.addressbook.impl.ABContactCategoryScoreImpl");
    ...
    config.put("gw.ab.addressbook.entity.ABContactCategoryScore", "com.guidewire.ab.domain.addressbook.impl.ABContactCategoryScoreImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ABContactCategoryScore.class, config);
    com.guidewire._generated.entity.ABContactCategoryScoreInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ABContactCategoryScore, com.guidewire._generated.entity.ABContactCategoryScoreInternal>() {
      public java.lang.Object getImplementation(entity.ABContactCategoryScore bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ABContactCategoryScoreInternal getInternalInterface(entity.ABContactCategoryScore bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ABContactCategoryScore newEmptyInstance() {
        return new entity.ABContactCategoryScore((java.lang.Void)null);
      }
