...
@javax.annotation.processing.Generated("config/web/pcf/admin/workflow/WorkflowSearch.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class WorkflowSearchExpressions {
  ...
  public static class SearchPanelExpressionsImpl extends WorkflowSearchExpressionsImpl {
    ...
    // 'action' attribute on ToolbarButton (id=Workflows_ManageAllButton) at WorkflowSearch.pcf: line 39, column 29
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=Workflows_ManageButton) at WorkflowSearch.pcf: line 33, column 29
    ...
    // 'available' attribute on ToolbarButton (id=Workflows_ManageAllButton) at WorkflowSearch.pcf: line 39, column 29
