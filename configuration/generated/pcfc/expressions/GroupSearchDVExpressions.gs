...
@javax.annotation.processing.Generated("config/web/pcf/shared/groupsearch/GroupSearchDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class GroupSearchDVExpressions {
  ...
  public static class GroupSearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeInput (id=GroupType_Input) at GroupSearchDV.pcf: line 33, column 40
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      SearchCriteria.GroupType = (__VALUE_TO_SET as typekey.GroupType)
    }
    
    // 'value' attribute on TextInput (id=GroupName_Input) at GroupSearchDV.pcf: line 15, column 43
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      SearchCriteria.GroupName = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=GroupNameKanji_Input) at GroupSearchDV.pcf: line 21, column 84
    function defaultSetter_8 (__VALUE_TO_SET :  java.lang.Object) : void {
      SearchCriteria.GroupNameKanji = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'filter' attribute on RangeInput (id=GroupType_Input) at GroupSearchDV.pcf: line 33, column 40
    function filter_15 (VALUE :  typekey.GroupType, VALUES :  typekey.GroupType[]) : java.lang.Boolean {
      return VALUE != TC_ROOT
    }
    
    // 'label' attribute on TextInput (id=GroupName_Input) at GroupSearchDV.pcf: line 15, column 43
    ...
    // 'valueRange' attribute on RangeInput (id=GroupType_Input) at GroupSearchDV.pcf: line 33, column 40
    ...
    // 'valueRange' attribute on RangeInput (id=GroupType_Input) at GroupSearchDV.pcf: line 33, column 40
    function verifyValueRangeIsAllowedType_17 ($$arg :  typekey.GroupType[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'visible' attribute on TextInput (id=GroupNameKanji_Input) at GroupSearchDV.pcf: line 21, column 84
