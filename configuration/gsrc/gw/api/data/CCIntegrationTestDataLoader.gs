...
uses gw.api.databuilder.ABInsuranceCompanyBuilder
uses gw.api.databuilder.ABLawFirmBuilder
uses gw.api.databuilder.ABMedicalCareOrgBuilder
uses gw.api.databuilder.ABOfficialIDBuilder
...
//    new DataSets().createDefaultSampleData(null)
    ...
    new ABInsuranceCompanyBuilder()
            .withName("Tokyo Insurance")
            .withABOfficialIds(
                new ABOfficialIDBuilder()
                    .withOfficialType(OfficialIDType.TC_BUREAUID)
                    .withOfficialValue("11-1234")
            )
            .createAndCommit()

    new ABInsuranceCompanyBuilder()
            .withName("Kanagawa Insurance")
            .withTags({TC_CLIENT})
            .withABOfficialIds(
                new ABOfficialIDBuilder()
                    .withOfficialType(OfficialIDType.TC_BUREAUID)
                    .withOfficialValue("12-1234")
                    .withJurisdiction(Jurisdiction.TC_CA)
            )
            .createAndCommit()

    new ABInsuranceCompanyBuilder()
        .withName("Chiba Insurance")
        .withTags({TC_CLIENT})
            .createAndCommit()
