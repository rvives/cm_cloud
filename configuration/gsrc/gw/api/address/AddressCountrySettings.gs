...
class AddressCountrySettings {
  ...
  private static final var DEFAULT_FIELDS = new HashSet<AddressOwnerFieldId>() {
  ...
  /**
   * The postal code regex for validation.
   *
   */
  public property get PostalCodeRegex() : String {
    return _countryConfig.getPostalCodeRegex();
  }
