...
public class ContactMapper extends ContactMapperABBase {
  ...
  override property get Mappings() : Set<PropertyMapping> {
    return {
        ...
        //ABOfficialID
        arrayMapping(ABContact#ABOfficialIDs),
        fieldMapping(ABOfficialID#LinkID)
            .withMappingDirection(TO_XML),
        fieldMapping(ABOfficialID#External_PublicID),
        fieldMapping(ABOfficialID#External_UniqueID),
        fieldMapping(ABOfficialID#OfficialIDType),
        fieldMapping(ABOfficialID#OfficialIDValue),
        fieldMapping(ABOfficialID#State)
    }
  }
}
