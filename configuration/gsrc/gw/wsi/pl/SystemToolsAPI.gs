...
uses gw.upgrade.RequestedUpgrade
uses gw.upgrade.VerifyConfigReportOptions
...
class SystemToolsAPI {
  ...
  /**
   * Deactivates a user and terminates any existing sessions
   * @param userName
   * @return true if the specified user was already activated and deactivated, false otherwise
   */
  @WsiPermissions({SystemPermissionType.TC_USEREDIT, SystemPermissionType.TC_SOAPADMIN})
  @Throws(WsiAuthenticationException,"On permission or authentication errors")
  @Throws(BadIdentifierException, "if username not found")
  public function deactivateUser(userName : String ) : boolean {
    return new SystemToolsImpl().deactivateUser(userName)
  }
  ...
  */
  @Throws(WsiAuthenticationException,"On permission or authentication errors")
  public function verifyConfig(requestedUpgrade : RequestedUpgrade,
                               appVerifiersConfigFP : String,
                               plVerifiersConfigFP : String,
                               fileDigestPairs : FilenameDigestPair[],
                               reportOptions : VerifyConfigReportOptions) : String {
    return new SystemToolsImpl().verifyConfig(requestedUpgrade, appVerifiersConfigFP, plVerifiersConfigFP, fileDigestPairs, reportOptions)
  }
   ...
   */
  @Throws(WsiAuthenticationException,"On permission or authentication errors")
  public function verifyConfigUsingRemoteExtCfg(requestedUpgrade : RequestedUpgrade,
                                                appVerifiersConfigFP : String,
                                                plVerifiersConfigFP : String,
                                                compressedFiles : FilenameDigestPair[],
                                                reportOptions : VerifyConfigReportOptions) : String {
    return new SystemToolsImpl().verifyConfigUsingRemoteExtCfg(requestedUpgrade, appVerifiersConfigFP, plVerifiersConfigFP, compressedFiles, reportOptions)
  }
